describe('CSSLocator', () =>{
    ...
    // Step 1: Enter search text and submit search form
    it('step1: searchbox',()=>{
        ...
        cy.get("#twotabsearchtextbox").type("mens shoes") // Enter "mens shoes" in search textbox

        cy.get("#nav-search-submit-button").click() // Click on search submit button

        cy.get(".a-color-state a-text-bold").contains("mens shoes") // Verify search results for "mens shoes"
    })
